...
export default class ListenSentencesScreen extends Component<Props> {
  constructor(props) {
    super(props);
    this.state = ({
      isSelected1: false,
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.headerContainer}>
          <Text style={styles.contentText2}>Listen to the Sentences</Text>
        </View>
        ...
        <TouchableOpacity style={styles.listCardContainer} onPress={() => this.toggleSoundIcon(2)}>
          <Text style={styles.contentText}>Au revoir</Text>
        ...
        <TouchableOpacity  style={styles.buttonContainer2} onPress={() => this.toggleSoundIcon(3)}>
          <Text>Simulate Next</Text>
        </TouchableOpacity>
